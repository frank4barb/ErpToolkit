...
namespace ErpToolkit.Controllers.SIO.HealthData
{
    public class DocumentoClinicoController : ControllerErp
    {
        ...
        [BindProperty]
        public SelDocumentoClinico Select { get; set; }  = new SelDocumentoClinico();
        [BindProperty]
        public List<DocumentoClinico> List { get {
                List<DocumentoClinico> list = new List<DocumentoClinico>();
                try { list = DogHelper.List<DocumentoClinico>(DbConnectionString, Select); }
        ...
        public IActionResult Edit([FromBody] ModalParams parms)  
        {
            ...
            {
                try { obj = DogHelper.Row<DocumentoClinico>(DbConnectionString, parms.Id); }
