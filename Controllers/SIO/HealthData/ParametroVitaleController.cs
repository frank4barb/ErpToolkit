...
namespace ErpToolkit.Controllers.SIO.HealthData
{
    public class ParametroVitaleController : ControllerErp
    {
        ...
        public IActionResult Save([FromBody] ModelObject dataObj)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Oggetto ParametroVitale non valido. null");
                return PartialView("~/Views/SIO/HealthData/ParametroVitale/_PartialEdit.cshtml", null);
            }
            ParametroVitale obj = System.Text.Json.JsonSerializer.Deserialize<ParametroVitale>((System.Text.Json.JsonElement)dataObj.data);
            ModelState.Clear(); //FORZA RICONVALIDA MODELLO 
