...
namespace ErpToolkit.Controllers.SIO.Act
{
    public class TipoEpisodioController : ControllerErp
    {
        ...
        {
            TipoEpisodio obj = this.ReadForEditModel<TipoEpisodio>(parms);
        ...
        {
            TipoEpisodio obj = this.SaveModel<TipoEpisodio>(dataObj);
        ...
        {
            TipoEpisodio obj = this.ReadForDeleteModel<TipoEpisodio>(parms);
        ...
        {
            TipoEpisodio obj = this.DeleteModel<TipoEpisodio>(dataObj);
