...
namespace ErpToolkit.Controllers.SIO.Act
{
    public class TipoOrganizzazioneController : ControllerErp
    {
        ...
        [BindProperty]
        public SelTipoOrganizzazione Select { get; set; }  = new SelTipoOrganizzazione();
        [BindProperty]
        public List<TipoOrganizzazione> List { get {
                List<TipoOrganizzazione> list = new List<TipoOrganizzazione>();
                try { list = DogHelper.List<TipoOrganizzazione>(DbConnectionString, Select); }
