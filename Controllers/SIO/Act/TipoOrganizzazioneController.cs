...
namespace ErpToolkit.Controllers.SIO.Act
{
    public class TipoOrganizzazioneController : ControllerErp
    {
        ...
        {
            TipoOrganizzazione obj = this.ReadForEditModel<TipoOrganizzazione>(parms);
        ...
        {
            TipoOrganizzazione obj = this.ReadForDeleteModel<TipoOrganizzazione>(parms);
        ...
        {
            TipoOrganizzazione obj = this.DeleteModel<TipoOrganizzazione>(dataObj);
