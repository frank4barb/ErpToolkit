...
namespace ErpToolkit.Controllers.SIO.Resource
{
    public class PersonaleController : ControllerErp
    {
        ...
        [BindProperty]
        public SelPersonale Select { get; set; }  = new SelPersonale();
        [BindProperty]
        public List<Personale> List { get {
                List<Personale> list = new List<Personale>();
                try { list = DogHelper.List<Personale>(DbConnectionString, Select); }
