...
namespace ErpToolkit.Controllers.SIO.Resource
{
    public class FarmacoController : ControllerErp
    {
        ...
        {
            Farmaco obj = this.ReadForEditModel<Farmaco>(parms);
        ...
        {
            Farmaco obj = this.SaveModel<Farmaco>(dataObj);
        ...
        {
            Farmaco obj = this.ReadForDeleteModel<Farmaco>(parms);
        ...
        {
            Farmaco obj = this.DeleteModel<Farmaco>(dataObj);
