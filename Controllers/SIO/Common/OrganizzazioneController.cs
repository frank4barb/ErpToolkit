...
namespace ErpToolkit.Controllers.SIO.Common
{
    public class OrganizzazioneController : ControllerErp
    {
        ...
        {
            Organizzazione obj = this.ReadForEditModel<Organizzazione>(parms);
        ...
        {
            Organizzazione obj = this.ReadForDeleteModel<Organizzazione>(parms);
        ...
        {
            Organizzazione obj = this.DeleteModel<Organizzazione>(dataObj);
