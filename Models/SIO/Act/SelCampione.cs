...
[ErpDogField("CP_ID_TIPO_CAMPIONE", SqlFieldNameExt="CP_ID_TIPO_CAMPIONE", SqlFieldOptions="", SqlFieldProperties="prop() xref(TIPO_CAMPIONE.TP__ICODE) xdup() multbxref()")]
[DefaultValue("")]
[AutocompleteClient("TipoCampione", "AutocompleteGetAll", 10)]
[DataType(DataType.Text)]
public List<string> CpIdTipoCampione  { get; set; } = new List<string>();

[Display(Name = "Descrizione", ShortName="", Description = "Descrizione del campione", Prompt="")]
[ErpDogField("CP_DESCRIZIONE", SqlFieldNameExt="CP_DESCRIZIONE", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_CODICE_UNIVOCO", SqlFieldNameExt="CP_CODICE_UNIVOCO", SqlFieldOptions="[UID]", SqlFieldProperties="prop() xref() xdup(CAMPIONE.CP__ICODE[CP__ICODE] {CP_CODICE_UNIVOCO=' '}) multbxref()")]
[DataType(DataType.Text)]
public string? CpCodiceUnivoco  { get; set; }

[Display(Name = "Data Prelievo", ShortName="", Description = "Data di raccolta", Prompt="")]
[ErpDogField("CP_DATA_PRELIEVO", SqlFieldNameExt="CP_DATA_PRELIEVO", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DateRange]
[DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
public DateRange CpDataPrelievo  { get; set; } = new DateRange();

[Display(Name = "Ora Prelievo", ShortName="", Description = "Ora di raccolta", Prompt="")]
[ErpDogField("CP_ORA_PRELIEVO", SqlFieldNameExt="CP_ORA_PRELIEVO", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue(" ")]
...
[ErpDogField("CP_NOTE", SqlFieldNameExt="CP_NOTE", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
public string? CpNote  { get; set; }

[Display(Name = "Id Episodio", ShortName="", Description = "Codice del contatto", Prompt="")]
[ErpDogField("CP_ID_EPISODIO", SqlFieldNameExt="CP_ID_EPISODIO", SqlFieldOptions="", SqlFieldProperties="prop() xref(EPISODIO.EP__ICODE) xdup() multbxref()")]
[DefaultValue("")]
[AutocompleteServer("Episodio", "AutocompleteGetSelect", "AutocompletePreLoad", 10)]
[DataType(DataType.Text)]
public List<string> CpIdEpisodio  { get; set; } = new List<string>();

[Display(Name = "Id Paziente", ShortName="", Description = "Codice del paziente", Prompt="")]
[ErpDogField("CP_ID_PAZIENTE", SqlFieldNameExt="CP_ID_PAZIENTE", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_CODICE_ASSOLUTO", SqlFieldNameExt="CP_CODICE_ASSOLUTO", SqlFieldOptions="[UID]", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_STATO_CAMPIONE", SqlFieldNameExt="CP_STATO_CAMPIONE", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue("0")]
...
[ErpDogField("CP_ID_POSIZIONE_ATTUALE", SqlFieldNameExt="CP_ID_POSIZIONE_ATTUALE", SqlFieldOptions="", SqlFieldProperties="prop() xref(ORGANIZZAZIONE.OR__ICODE) xdup() multbxref()")]
[DefaultValue("")]
[AutocompleteClient("Organizzazione", "AutocompleteGetAll", 10)]
[DataType(DataType.Text)]
public List<string> CpIdPosizioneAttuale  { get; set; } = new List<string>();

[Display(Name = "Desc Posizione Attuale", ShortName="", Description = "Posizione attuale testuale del campione", Prompt="")]
[ErpDogField("CP_DESC_POSIZIONE_ATTUALE", SqlFieldNameExt="CP_DESC_POSIZIONE_ATTUALE", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_DATA_CAMBIAMENTO_STATO", SqlFieldNameExt="CP_DATA_CAMBIAMENTO_STATO", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_ORA_CAMBIAMENTO_STATO", SqlFieldNameExt="CP_ORA_CAMBIAMENTO_STATO", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
...
[ErpDogField("CP_NOTE_CAMBIAMENTO_STATO", SqlFieldNameExt="CP_NOTE_CAMBIAMENTO_STATO", SqlFieldOptions="", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DataType(DataType.Text)]
