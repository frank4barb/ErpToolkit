...
[ErpDogField("OO_ID_ORGANIZZAZIONE_PADRE", SqlFieldNameExt="OO_ID_ORGANIZZAZIONE_PADRE", SqlFieldProperties="prop() xref(ORGANIZZAZIONE.OR__ICODE) xdup() multbxref()")]
...
[ErpDogField("OO_ID_ORGANIZZAZIONE_FIGLIO", SqlFieldNameExt="OO_ID_ORGANIZZAZIONE_FIGLIO", SqlFieldProperties="prop() xref(ORGANIZZAZIONE.OR__ICODE) xdup() multbxref()")]
[Required(ErrorMessage = "Inserire un valore nel campo")]
[DefaultValue("")]
[AutocompleteClient("Organizzazione", "AutocompleteGetAll", 1)]
[DataType(DataType.Text)]
...
[ErpDogField("OO_REGOLA_DI_INCLUSIONE", SqlFieldNameExt="OO_REGOLA_DI_INCLUSIONE", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue(" ")]
[StringLength(12, ErrorMessage = "Inserire massimo 12 caratteri")]
[DataType(DataType.Text)]
...
[ErpDogField("OO_NOTE", SqlFieldNameExt="OO_NOTE", SqlFieldProperties="prop() xref() xdup() multbxref()")]
[DefaultValue(" ")]
